--====================================================================================================--
--==  File Name: tl_findValueLocation                                                               ==--
--==  File Type: Store Procedure                                                                    ==--
--==  Desc     : This store procedure will print out SP with required changes                       ==--
--==  Example  : EXEC dbo.tl_findValueLocation 'dbo','tmpHelptext', 'txtText', 'pkiHelpTextID',     ==--
--==			       'SET NOCOUNT', 1391, 1384, 'pkiHelpTextID', 'ASC', @intReturn OUTPUT               ==--                                                                                 
--====================================================================================================--

IF OBJECT_ID('dbo.tl_findValueLocation', 'P') IS NOT NULL
BEGIN
	PRINT '[DROP]:[Droppig the following store procedure {dbo.tl_findValueLocation}]'
	DROP PROCEDURE [dbo].[tl_findValueLocation]
END
GO
...
CREATE PROCEDURE [dbo].[tl_findValueLocation] 
(
